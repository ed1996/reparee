ActiveAdmin.register User do
  ...
  #
   permit_params do
     permitted = [:email, :encrypted_password, :reset_password_token, :reset_password_sent_at, :remember_created_at, :fullname, :avatar_file_name, :avatar_content_type, :avatar_file_size, :avatar_updated_at, :confirmation_token, :confirmed_at, :confirmation_sent_at, :subscribed, :stripeid]
